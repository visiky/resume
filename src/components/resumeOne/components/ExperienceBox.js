...
const ExperienceBox = (props) => {
    return (
        ...
        {   
            ...
            const {experienceType, experienceDescription, imgUrl, refLink} = {...experience};        
            return <li className={'experience-list-item experience-list-item_' + experienceType}  key={'experience'+experienceType}>
                {
                    ((url) => {
                        if (url) 
