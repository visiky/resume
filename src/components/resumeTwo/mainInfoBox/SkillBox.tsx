  ...
  return (
    <span className="star-group">
      <i
        ...
        style={{ color: number > 20 ? '#ffc300' : '#fff' }}
      ></i>
      <i
        className="fa fa-star"
        style={{ color: number > 40 ? '#ffc300' : '#fff' }}
      ></i>
      <i
        className="fa fa-star"
        style={{ color: number > 60 ? '#ffc300' : '#fff' }}
      ></i>
      <i
        className="fa fa-star"
        style={{ color: number >= 80 ? '#ffc300' : '#fff' }}
      ></i>
      <i
        className="fa fa-star"
            ...
            {skillDescription1 && (
              <p>
                <i
                  ...
                  style={{
                    marginRight: '5px',
                    color: styleColor ? styleColor : 'orange',
                  }}
                ></i>
                {skillDescription1}
              </p>
