...
class BasicInfoBox extends Component{
    ...
    render(){
        ...
        const basicInfo = _.omit(this.props.basicInfo,"avatar","fullname","jobTitle");
        return(
            <div className="basic-info-box" style={ customStyle.infoBox }>
                <div style={{textAlign:"center",margin:"30px 0"}}>
                    <img src={ avatar ? avatar : "/images/avatar.png" } alt="" width="120px" height="120px" style={ customStyle.avatar }/>
