  ...
  experiences: [
    {
      ...
      experienceDescription:
        '课程设计做的在线考试系统。项目中主要负责前端界面开发及Mysql数据库设计，与两名java程序员进行开发,使用git进行版本控制作为小组组长,进行需求分析,网站整体架构和布局的设计，进行前端界面编写，利用ajax和后台进行数据交互。利用bootstrap进行整体前端框架以及使用改造的easy.ui数据网格插件',
    },
    {
      // experienceType: 'music_player',
      experienceType: '音乐播放器',
      experienceDescription:
        '一款使用vue搭建仿造网易云音乐的音乐播放器,项目为独立开发项目，结合vuex,vueresource,vuerouter进行开发.使用webpack进行项目打包仿造网易云完成项目的全部样式，可适应safari移动端;可进行歌单搜索，歌手搜索，在线音乐播放等功能利用nodejs搭建服务器后台,为项目提供后台数据API。整个过程的开发加深了自己对于MVVVM框架的理解。',
    },
    {
      // experienceType: 'resume_generator',
      experienceType: '在线简历生成器',
      experienceDescription:
        '从一个类似JSON数据的js文件读取数据,然后生成静态网页的简历生成器,使用了webpack和react技术',
    },
  ],
  skills: [
    {
      ...
      skillLevel: '90',
      skillDescription1:
        '熟悉原生Javascript，能脱离jQuery等类库编码；了解ECMAScript新标准,并能在项目中使用；了解javascript函数式编程',
    ...
    },
    {
      ...
      skillLevel: '50%',
      skillDescription1:
        '能够进行简单node服务器的开发,使用node开发过音乐播放器api',
