...
import { setBasicInfo, setExperience, setAppraisal, setFormSchema, setStyleColor, setSkill, clearSet, newSet,setTemplate }from '../actions';
	...
	render(){
		return (
			<div className="leftSection">
				<SiderBarDrawer stepMove={(index)=>{this.props.setFormSchema(index);}} setStyleColor={(color) =>{this.props.setStyleColor(color);}} setTemplate={this.props.setTemplate}/>
				<InfoForm {...this.props}/>
			</div>
		);
	}
